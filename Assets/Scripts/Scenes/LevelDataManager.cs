...
namespace JammerDash.Tech
{
    public class LevelDataManager : MonoBehaviour
    {
        ...
        private IEnumerator ProcessAfterSceneLoaded()
        {
            ...
            string json = File.ReadAllText(filePath);
            SceneData sceneData = SceneData.FromJson(json);
            UnityEngine.Debug.Log(sceneData.levelName);
            ...
            foreach (Vector3 cubePos in sceneData.cubePositions)
            {
                ...
                UnityEngine.Debug.Log("Cube instantiated: " + cubeObject);
            ...
            for (int i = 0; i < sceneData.longCubePositions.Count; i++)
            {
                ...
                UnityEngine.Debug.Log("Instantiated long cube");
            }
        ...
        private IEnumerator LoadImageCoroutine(string url)
        {
            ...
            UnityEngine.Debug.Log("Loading image from URL: " + url); // Log the URL for debugging purposes
